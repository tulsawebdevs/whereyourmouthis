...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Violation.code'
        db.add_column('inspections_violation', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Violation.code'
        db.delete_column('inspections_violation', 'code')
