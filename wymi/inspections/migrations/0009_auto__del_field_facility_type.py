...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Facility.type'
        db.delete_column('inspections_facility', 'type')


    def backwards(self, orm):
        
        # Adding field 'Facility.type'
        db.add_column('inspections_facility', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
