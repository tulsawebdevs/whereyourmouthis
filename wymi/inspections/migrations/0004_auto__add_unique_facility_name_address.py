...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Facility', fields ['name', 'address']
        db.create_unique('inspections_facility', ['name', 'address'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Facility', fields ['name', 'address']
        db.delete_unique('inspections_facility', ['name', 'address'])
