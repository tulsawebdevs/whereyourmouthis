...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Facility.latest_score'
        db.add_column('inspections_facility', 'latest_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Facility.latest_score'
        db.delete_column('inspections_facility', 'latest_score')
