...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    coffee: {
      app: {
        src: ['static/app_src/**/*.coffee'],
        dest: 'static/app',
        options: {
            bare: true,
            preserve_dirs: true,
            base_path: 'static/app_src'
        }
      }
    },
    ...
    lint: {
      files: [
        "status/app/config.js", "static/app/**/*.js"
      ]
    },
    ...
    // remove this, ensure concat is updated accordingly.
    handlebars: {
      "static/dist/debug/templates.js": ["app/templates/**/*.html"]
    },
    ...
    concat: {
      dist: {
        ...
        dest: "static/dist/debug/require.js",
    ...
    stylus: {
      ...
      compile: {
        // Used for @imports.
        options: { paths: ["static/css"] },
        
        files: {
          "static/dist/debug/index.css": "<config:stylus.files>"
        }
      },
      ...
      dev: {
        // Used for @imports.
        options: { paths: ["static/assets/css"] },
        
        files: {
          "static/assets/css/index.css": "<config:stylus.files>"
        }
      }
    },
    ...
    server: {
      ...
      debug: {
        ...
        folders: {
          ...
          "static/assets/js/libs": "static/dist/debug",
          "static/assets/css": "static/dist/debug"
        }
      },
      ...
      release: {
        ...
        folders: {
          ...
          "static/assets/js/libs": "static/dist/release",
          "static/assets/css": "static/dist/release"
        }
      }
    },
    ...
    watch: {
      stylus: {
        files: ["grunt.js", "static/app/css/**/*.styl"],
        tasks: "stylus:dev"
      },
      coffee: {
        files: ["grunt.js", 'static/app_src/**/*.coffee'],
        tasks: "coffee:app"
      }
    }
  ...
  grunt.registerTask("debug", "clean lint jst requirejs stylus:compile concat");
